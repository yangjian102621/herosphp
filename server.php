...
if (!defined('RUNTIME_PATH')) define('RUNTIME_PATH', __DIR__ . DIRECTORY_SEPARATOR . 'runtime/');
if (!defined('PUBLIC_PATH')) define('PUBLIC_PATH', __DIR__ . DIRECTORY_SEPARATOR . 'public/');
